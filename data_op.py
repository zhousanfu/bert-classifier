...
if __name__ == '__main__':
    ...
    pd_all = pd.read_excel(os.path.join(path, 'imo_v1.xlsx'))
    ...
    with open(r'C:\Users\Administrator\Documents\GitHub\bert_model\imo_v1\train.csv', 'w', encoding='utf-8') as dstFile:
    ...
    with open(r'C:\Users\Administrator\Documents\GitHub\bert_model\imo_v1\dev.csv', 'w', encoding='utf-8') as dstFile:
    ...
    with open(r'C:\Users\Administrator\Documents\GitHub\bert_model\imo_v1\test.csv', 'w', encoding='utf-8') as dstFile:
